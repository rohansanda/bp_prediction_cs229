...
""" To add more models, add a new elif statement below and add the model to the config.py file.
    Then import the model and config struct at the top of this code. I've used this infrastructure
    style so the code is easy to expand for future research.
    RUN THIS SCRIPT TO RUN YOUR MODEL. """
